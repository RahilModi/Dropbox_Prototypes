...
var updateUserProfileDataReq = function(req,res){
    ...
    updateUserProfileData(data,function(err,results){
        if(err){
            console.log(err);
        }else{
...
var updateUserProfileData = function(dataJson,callback){
    ...
    var data ={$set:{profile:{work:dataJson.work,sports:dataJson.sports,mobile:dataJson.mobile,education:dataJson.education}}};
