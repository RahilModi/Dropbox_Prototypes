                ...
                <Panel className="login-panel">
                    ...
                    <form  >
                        <fieldset>
                            ...
                            <Button style={bgcolor} disabled={!this.state.formValid} onClick={() => this.props.handleSignUp(this.state)} bsSize="large" bsStyle="success" block>Register</Button>
                            <p style={alignCenter}>Already have an account?
                                <a href="login" onClick={() =>{ this.props.history.push("/login");}}>Login</a>
                            </p>
