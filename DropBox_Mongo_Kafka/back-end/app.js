...
app.post('/getDir',authentication.requireLogin, filelist.getFileList);
...
app.post('/star',authentication.requireLogin,star.stardir);
app.post('/logout',authentication.requireLogin,login.signout);
app.post('/getUserLogs',authentication.requireLogin,userProfile.getuserlogs);
...
app.post('/validateEmails',authentication.requireLogin,fileOperations.validateEmails);
app.post('/shareFile',authentication.requireLogin,fileOperations.shareFile);
app.post('/download',fileOperations.download );
app.post('/login',login.signin);
app.post('/logout',authentication.requireLogin,login.signout);

app.post('/getUserGroups',authentication.requireLogin, usergroups.getUserGroups);
app.post('/setUserGroups',authentication.requireLogin, usergroups.setUserGroups);
